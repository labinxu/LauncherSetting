...
public class DeviceProfile {
    ...
    private void updateAvailableDimensions(Context context) {
        ...
        //jeremy
        //availableHeightPx = size.y;
        int statusbarHeight = (int)Math.ceil(25*dm.density);
        availableHeightPx = realSize.y- statusbarHeight;
        
        if (LOGD) {
        	Log.d(TAG, "Jeremy-------DeviceProfile-----updateAvailableDimensions----size: " + size.toString());
        	Log.d(TAG, "Jeremy-------DeviceProfile-----updateAvailableDimensions----realSize: " + realSize.toString());
        	Log.d(TAG, "Jeremy-------DeviceProfile-----updateAvailableDimensions----availableHeightPx: " + availableHeightPx);
        	Log.d(TAG, "Jeremy-------DeviceProfile-----updateAvailableDimensions----smallestSize: " + smallestSize.toString());
        	Log.d(TAG, "Jeremy-------DeviceProfile-----updateAvailableDimensions----largestSize: " + largestSize.toString());
        }
    ...
    void updateFromConfiguration(Context context, Resources resources, int wPx, int hPx,
        ...
        if (LOGD) {
        	Log.d(TAG, "Jeremy-------DeviceProfile-----updateFromConfiguration----widthPx: " + widthPx);
        	Log.d(TAG, "Jeremy-------DeviceProfile-----updateFromConfiguration----heightPx: " + heightPx);
        	Log.d(TAG, "Jeremy-------DeviceProfile-----updateFromConfiguration----availableWidthPx: " + availableWidthPx);
        	Log.d(TAG, "Jeremy-------DeviceProfile-----updateFromConfiguration----availableHeightPx: " + availableHeightPx);
        }
